import type { IPriceLine, ISeriesApi, PriceLineOptions, SeriesDataItemTypeMap, SeriesPartialOptionsMap, SeriesType } from 'lightweight-charts';
...
export declare type Action<TTarget extends Element, TParams> = (target: TTarget, params: TParams) => ActionResult<TParams>;
...
export declare type SeriesActionParams = AreaSeriesParams | BarSeriesParams | CandlestickSeriesParams | HistogramSeriesParams | LineSeriesParams;
...
export declare type Reference<T> = (ref: T | null) => void;
